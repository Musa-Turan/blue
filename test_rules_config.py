...
url_rules = f"https://{os.environ.get('WAZUH_MANAGER_IP', '127.0.0.1')}:55000/rules?rule_ids=100010,100011"
...
url_conf = f"https://{os.environ.get('WAZUH_MANAGER_IP', '127.0.0.1')}:55000/agents/001/config/localfile/localfile"
